...
class SuppliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create supply" do
    assert_difference('Supply.count') do
      post supplies_url, params: { supply: { art_name: @supply.art_name, art_type: @supply.art_type, del_date: @supply.del_date, stock: @supply.stock } }
    end
  ...
  test "should update supply" do
    patch supply_url(@supply), params: { supply: { art_name: @supply.art_name, art_type: @supply.art_type, del_date: @supply.del_date, stock: @supply.stock } }
